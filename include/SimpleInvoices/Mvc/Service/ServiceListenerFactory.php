...
use SimpleInvoices\Mvc\View\Http\DefaultRenderingStrategy;
use ReflectionClass;
...
class ServiceListenerFactory implements FactoryInterface
{
    ...
    protected $defaultServiceConfig = [
        'aliases' => [
            ...
            'ViewPhpRenderer'                            => \SimpleInvoices\Smarty\SmartyRenderer::class,
            'ViewRenderer'                               => \SimpleInvoices\Smarty\SmartyRenderer::class,
        ...
        'factories'  => [
            ...
            \SimpleInvoices\Smarty\SmartyRenderer::class         => ViewSmartyRendererFactory::class,
