<?php
namespace SimpleInvoices\Security;

/**
 * Used for credit card encryption.
 * 
 * TODO: This should go out of here as Credit Card should be
 *       an extension and not part of core as it is illegal in many countries.
 */
class Encryption
{
